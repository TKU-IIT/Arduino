...
uchar serNum[5];
 int chpD58EB308 = 0;//1
    ...
    int chp460F232B = 0;//12//        memcpy(serNum, str, 5);
//    ////////////////
...
//        Serial.print("The card's number is: ");
        memcpy(serNum, str, 5);
//        ShowCardID(serNum);hpD58EB308 = EEPROM.read(1);//1
   ...
   // }/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //}/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      myGLCD.clrScr();
      myGLCD.print("The card's ", LEFT, 0); MFRC522_Init();
      myGLCD.print(" balance:", LEFT, 10);
    ...
    //}/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      int value8=-5000;char key = keypad.getKey();
        ...
        if (key == '9') {value1=value1*(-1);value2=value2*(-1);value3=value3*(-1); MFRC522_Init();value4=value4*(-1);value5=value5*(-1);value6=value6*(-1);value7=value7*(-1);value8=value8*(-1);}
        if (key == '0') {}
      //斜線匡起來的區域拷貝在任何有else if陳敘式的大刮弧裡面
    //}/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    }
  ...
  //  }/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   // }/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      int value7=-500;   
      int value8=-5000;
         if(chpA4F88950+value1>=0){if (key=='1') {chpA4F88950=chpA4F88950+value1;}}//E
         if(chpA4F88950+value2>=0){if (key == '2') {chpA4F88950=chpA4F88950+value2;}}
         if(chpA4F88950+value3>=0){if (key == '3') {chpA4F88950=chpA4F88950+value3;}}
         if(chpA4F88950+value4>=0){if (key == '4') {chpA4F88950=chpA4F88950+value4;}}
         if(chpA4F88950+value5>=0){if (key == '5') {chpA4F88950=chpA4F88950+value5;}}
         if(chpA4F88950+value6>=0){if (key == '6') {chpA4F88950=chpA4F88950+value6;}}
         if(chpA4F88950+value7>=0){if (key == '7') {chpA4F88950=chpA4F88950+value7;}}
         if(chpA4F88950+value8>=0){if (key == '8') {chpA4F88950=chpA4F88950+value8;}}
        if (key == '9') {chpA4F88950=chpA4F88950-value1;}
        if (key == '*') {chpA4F88950=chpA4F88950-value2;}//改卡號
        if (key == '0') {chpA4F88950=chpA4F88950-value3;}
        if (key == '#') {chpA4F88950=chpA4F88950-value4;}
      //斜線匡起來的區域拷貝在任何有else if陳敘式的大刮弧裡面
    //}/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    }
...
EEPROM.write(11, chpD4893751);
EEPROM.write(12, chp49AFF7E6);
EEPROM.write(13, chpF5FEA804);
EEPROM.write(14, chpA4F88950);
EEPROM.write(15, chpD029FF01);
EEPROM.write(16, chpB29C63A9);
EEPROM.write(17, chpB29C63A9);
EEPROM.write(18, chpD4893751);
