...
int chpD59A9B04 = 0;//13
int chp82EEC801 = 0;//14
int chp244CFF69 = 0;//15
...
void Register(String x, String y, String z, String a, String b, String c, String d, String e, String Type)
{
  if (client.connect("120.126.84.79", 80)) {

    client.println("GET /RFID/add_data.php?CardNumber=" + String(x) + String(y) + String(z) + String(a) + String(b) + String(c) + String(d) + String(e) + "&CardBalance=0&CardType=" + String(Type) + " HTTP/1.1");
    client.println("Host: 120.126.84.79");
    client.println("Connection: close");
    client.println();lcd.setCursor(0,1);
...
void CardRegisterAsCY(uchar *id) {
  ...
  int card8 = 0x0F & id[3];
  Register(String(card, HEX), String(card2, HEX), String(card3, HEX), String(card4, HEX), String(card5, HEX), String(card6, HEX), String(card7, HEX), String(card8, HEX), "CYCHP");
  ...
  int card7 = 0x0F & (id[3] >> 4);
  int card8 = 0x0F & id[3];
  Register(String(card, HEX), String(card2, HEX), String(card3, HEX), String(card4, HEX), String(card5, HEX), String(card6, HEX), String(card7, HEX), String(card8, HEX), "ADCHP");
...
void CardRegisterAsEL(uchar *id) {
  ...
  int card7 = 0x0F & (id[3] >> 4);
  int card8 = 0x0F & id[3];
  Register(String(card, HEX), String(card2, HEX), String(card3, HEX), String(card4, HEX), String(card5, HEX), String(card6, HEX), String(card7, HEX), String(card8, HEX), "ELCHP");
